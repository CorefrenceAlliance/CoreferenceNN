...
public class BioNLPCorefEvaluator {
	...
	public static void main(String[] args) throws IOException {
            BioNLPCorefEvaluator evaluator = new BioNLPCorefEvaluator();
            
//            System.out.println("Enter annotationDirectory");
//            Scanner sc = new Scanner(System.in);
//            String dirAnnotation = sc.next();
